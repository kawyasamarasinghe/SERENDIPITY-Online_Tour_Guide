...
if(isset($_POST['submit']))
{
    ...
    $query="UPDATE preex SET name='$_POST[name]', feedback='$_POST[feedback]' WHERE id='$_POST[id]'";
    ...
    if($run)
    {
        ...
        header("Refresh:3; url=Admin_preEx.php");
    }
    else
    {
        $error = " Update Failed";
...
<head>
    <title>Admin Edit Previous Experiences</title>
...
<body>
<center>
<form action="Edit_Admin_PreEx.php" method="POST" >  
<fieldset id="edit" style="width: 630px; border-radius: 25px; background-color: #333;">
    <h3 class="title ">Edit Feedback </h3>  

                    <div class="input-container">
                        <input type="id" name="id" class="input"v required>
                        <label for=" ">ID</label>
                        <span>ID</span>
                    </div>
                    ...
                    <div class="input-container textarea">
                      <input type="feedback" name="feedback" class="input">
                        <label for=" ">Feedback</label>
                        <span>Feedback</span>
                    </div>

                    &emsp13;
                    <button id="submit" type="submit" class="butn" name="submit">Submit</button>
                    <br>  <br>
                    &emsp14;         
