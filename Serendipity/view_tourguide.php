...
<head>
    <title>View Tour guide Profile</title>
...
<body style="background-image:url(../Countries/Images/amazon_river.jpg); background-size:cover; font-family:-apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Oxygen, Ubuntu, Cantarell, 'Open Sans', 'Helvetica Neue', sans-serif;">
<!--Header-->
<div class="header">
    <br><br><br><br>
        <h2> &emsp;<b style="color: white;">View Tour guide Profiles</b></h2>
    </div>
    <br><br>
    <center>
    ...
    <tr>
        ...
        <th>First Name</th>
        <th>Last Name</th>
        <th style="width:100px; height:30px;">DOB</th>
        <th>Email</th>
		<th>Passport No</th>
        <th>Country</th>
		<th>Gender</th>
        ...
        <?php
            ...
            if($result -> num_rows > 0){
                while($row = $result-> fetch_assoc()){
					...
					<td><br><center>". $row["firstName"]. "</center><br></td>
                    <td><br><center>". $row["lastName"]. "</center><br></td>
					<td><br><center>". $row["dob"]. "</center><br></td>
					<td><br><center>". $row["email"]. "</center><br></td>
                    <td><br><center>". $row["passportno"]. "</center><br></td>
					<td><br><center>". $row["country"]. "</center><br></td>
                    <td><br><center>". $row["gender"]. "</center><br></td>
                    <td><br><center>". $row["bio"]. "</center><br></td>
					<td><br><center>". $row["experience"]. "</center><br></td>
                    

                    <td><a href ='Delete_tourguide.php?id = $row[id]'><input type ='submit' value ='Delete' name='send'></a></td>
                    </tr>";
                }
                echo "</table>";
            }
