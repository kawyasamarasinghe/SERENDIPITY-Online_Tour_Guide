...
if(isset($_POST['send']))
{
    ...
    $query = "DELETE FROM regtourguide WHERE id = '$id' LIMIT 1"; 
...
<head>
    <title>Admin Delete Tour Guide</title>
...
<div>
    ...
    <div class="btn ">
        <button class="button1" name="btn1 "><a class="logout" href="../Register TourGuide/logoutTG.php" id="button1" >Log Out</a></button>
    </div>
    ...
    <form action="Delete_tourguide.php" method="POST" >
            
            <br><br><br>
        <fieldset id="del" style="width: 630px; border-radius: 25px; background-color: #c9bb99">

        <h3 class="title ">Delete Tour Guide</h3><br>
